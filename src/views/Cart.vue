		...
		<div class="container container--cart">
			<div class="cart">
				...
				<div class="content__items">
					<div v-for="pizza in addedPizzas" :key="pizza.id" class="cart__item">
	...
	setup() {
		...
		if (cartItems.value.size > 0) {
			for (const item of cartItems.value.values()) {
				addedPizzas.value = [...addedPizzas.value, item];
        console.log(addedPizzas.value)
			}
		}
		return { addedPizzas };
	},
